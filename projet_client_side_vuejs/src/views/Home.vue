        ...
        <v-content class="home">
            <v-layout column>
                ...
                <v-flex xs2 class="select">
                    <v-menu offset-y>
                        <v-flex class="selectButton"
                                slot="activator"
                        >
                            <flag class="flagIcon" :squared="false" :iso="selectedCountry"/>
...
export default {
  ...
  methods: {
      ...
      toggle(country) {
          this.selectedCountry === "fr" ? this.selectedCountry = country : this.selectedCountry = "fr";
      },
      changeToDiet() {
